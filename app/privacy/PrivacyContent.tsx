export function PrivacyContent() {
    return (
        <div className="space-y-6 text-gray-300 text-sm leading-relaxed">
            <p>
                THOR SIGNALS ("our," "us," or "we") thanks you for visiting the online and mobile resources we publish. We use the words "you" and "your" to mean you, the reader, and other visitors to our online and mobile resources who are, in all cases, over the age of 13. Our privacy statement ("this statement," "this privacy statement," and "our statement") informs you about from whom and the types of personal information we collect, how we use it, who we share it with and why, and what we do to try to protect it.
            </p>
            <p>
            ...
            <p>
                <strong>California Notice of Collection of Personal Information:</strong> To learn more about your California privacy rights, please scroll down to "THE CALIFORNIA CONSUMER PRIVACY ACT."
            </p>

            <h3 className="text-xl font-semibold text-white mt-8 mb-4">WHO WE ARE</h3>
            <p>
                THOR SIGNALS is an education and training company, based in the United States of America. For residents from the GDPR Jurisdictions, as defined below, and some US state privacy laws, THOR SIGNALS is the data controller responsible for your personal data. For residents of California, THOR SIGNALS is a "Business."
            </p>

            <h3 className="text-xl font-semibold text-white mt-8 mb-4">WHO WE COLLECT PERSONAL INFORMATION FROM</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">WHAT WE COLLECT</h3>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Voluntarily Submitted Information</h4>
            <p>
            ...
            <p className="mt-4">Some of the ways you voluntarily give us your personal information and how we use it:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Emails and Online Forms</strong> – When you send us an email or fill out an online form, such as to contact us, your email address and any other personal information (e.g., home address or phone number) that may be in the content of your message or attached to it, are retained by us and used to respond back directly to you and to process your request. Depending on the personal information provided, communications from us may be in the form of emails, telephone calls, and/or text messages. We may also send you information about any of our products or services we think may be of interest to you.</li>
                <li><strong>Registering for an Account</strong> – When you register for an account, you submit personal information to us such as your name and email address which we then retain. We use that information to create and manage your account and, in some cases, establish a password and profile to communicate with you via email.</li>
                <li><strong>Registering for Events</strong> – When you register for services, webinars, events, conferences, or programs we ourselves may host (rather than outsourced to a third-party event manager with its own privacy policies), you will be submitting the types of identifiers described above. If the event requires a fee, we may also ask you to submit credit card or other financial information. We use this information to register you for the event and send you communications regarding the event.</li>
                <li><strong>Becoming a Subscriber to Our Service</strong> – We use any information provided from our customers to perform our contractual obligations and provide the products and services purchased to them, to manage their accounts and communicate with them.</li>
                <li><strong>Social Media and Community Features</strong> – Some of our online and mobile resources may offer social media-like community features letting users post messages and comments, and/or upload an image or other files and materials. If you choose to make use of these features, the information you post, including your screen name and any other personal information, will be in the public domain and not covered/protected by this statement.</li>
            </ul>

            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Use of AI Technology</h4>
            <p>
                Company may from time-to-time use Automated Information ("AI"). Company may use AI for the following purposes:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Processing personal data being processed;</li>
                <li>The purposes of the processing or use of the AI is to create a personal experience with customer; and</li>
                <li>Sourcing of data.</li>
            </ul>
            <p className="mt-4">
                When using Company's website you are prohibited from using AI in the following methods:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Illegally using AI-powered product in connection with Company or Company's clients;</li>
                <li>Copyright and related rights (if AI generates text, images, audio or other works protected by copyright);</li>
                <li>Monetization models (if you charge for an AI feature, but the monetization model does not provide for the same payment for each call through an API);</li>
                <li>Compliance with the requirements of the law on the protection of fair competition (for example, not to issue AI work for the work of a specific human artist);</li>
                <li>Guarantees of product performance (including AI as its components), as well as disclaimers and disclaimers of guarantees;</li>
                <li>Obligations for users of your product (or model) to disclose information about the use of AI (and the AI itself) in their own privacy policies;</li>
                <li>AI restrictions and limits imposed by you, the model provider or, for example, the platform where the product is used (photostocks, markets for illustrations or texts, for example);</li>
                <li>If relevant at the time you read this article, then also export or other restrictions adopted by the state on the use and/or sale of an AI product to other countries, etc.</li>
            </ul>

            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Automatically Collected Information</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">User Beware: External Sites, Apps, Links and Social Media</h4>
            <p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>To process transactions, such as purchases and subscriptions.</li>
                ...
                <li>To develop new products or services and to enhance current products and services.</li>
                <li>To send periodic emails about Services updates, your orders, or your subscription.</li>
                <li>To protect the security or integrity of our Services and our business, such as by protecting against and preventing fraud, unauthorized transactions, claims, and other liabilities.</li>
            </ul>

            <p className="mt-4">We may use your information for the following commercial purposes:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li>To send you marketing and promotional emails.</li>
                <li>To target prospective customers with our services (such targeting is only performed with your permission where your consent is required by applicable law).</li>
            </ul>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">WHEN/WITH WHOM DO WE SHARE PERSONAL INFORMATION</h3>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Affiliates</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Legally Compelled Disclosures</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">To Prevent Harm</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Business Transfer</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Vendors and Business Partners</h4>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">EMAIL COMMUNICATIONS, NEWSLETTERS, AND MARKETING</h3>
            <p>
                We may use Your Personal Data to contact You with newsletters, marketing or promotional materials and other information that may be of interest to You. You may opt-out of receiving any, or all, of these communications from Us by following the unsubscribe link or instructions provided in any email We send or by contacting Us.
            </p>

            <h3 className="text-xl font-semibold text-white mt-8 mb-4">PAYMENTS</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">YOUR RIGHTS AND OPTIONS</h3>
            <p>
            ...
            <p>
                <strong>Emails.</strong> If you consented to receive direct marketing from THOR Signals, we provide you with the opportunity to opt out of our marketing communications or change your preferences by following a link in the footer of all non-transactional email messages from us or by emailing us at info@thorsignals.com. Some communications from us are considered transactional or service communications (for example, account notifications and billing information). To ensure you have accurate information about your account and purchases, you do not have the option to unsubscribe from these messages.
            </p>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">CHILDREN'S PRIVACY</h3>
            <p>
                Federal law imposes special restrictions and obligations on commercial website operators who direct their operations toward, and collect and use information from, children under the age of 13. We take those age-related requirements very seriously, and consistent with it do not intend for our online and mobile resources to be used by children under the age of 18. If we become aware that anyone under the age of 18 has submitted personal information to our online and mobile resources, we will delete that information and will not use it for any purpose whatsoever. If you believe that someone under the age of 18 has submitted personal information to our online and mobile resources, please contact us at info@thorsignals.com. We encourage parents and legal guardians to talk with their children about the potential risks of providing personal information over the Internet.
            </p>

            <h3 className="text-xl font-semibold text-white mt-8 mb-4">HOW WE PROTECT COLLECTED PERSONAL INFORMATION</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">THE CALIFORNIA CONSUMER PRIVACY ACT</h3>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">What did we collect from California Residents?</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Rights of California Residents</h4>
            <p>
                If you are a California resident, you have the right to request the following:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Access:</strong> Up to two times per year, you can request that we disclose to you (1) the categories and specific pieces of personal information that we have collected from you; (2) the sources of that personal information; (3) the business or commercial purpose for that collection; (4) the categories of personal information we have disclosed for a commercial purpose; and (5) the categories of third parties with whom we have shared your personal information.</li>
                <li><strong>Deletion:</strong> You may also request that we delete any personal information that we have collected from or about you. There may be instances where we will not be able to fully comply with your request, such as if we need the personal information to complete a transaction for you, to detect and protect against fraudulent and illegal activity, to exercise our rights, for our internal purposes, or to comply with a legal obligation.</li>
            </ul>
            <p className="mt-4">
            ...
            <p>
                To exercise your rights under California law, just contact us at info@thorsignals.com. We may ask you to fill out a request form. The CCPA only allows us to act on your request if we can verify your identity or your authority to make the request so you will also need to follow our instructions for identity verification.
            </p>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">VIRGINIA RESIDENTS</h3>
            <p>
                If you are a Virginia resident, you may take advantage of certain privacy rights pursuant to Virginia Code 59.1-577. For example, you may request to access, correct, or delete your personal information. Because "selling" personal information and engaging in "targeted advertising" as these terms are defined in Virginia law, you may also exercise your right to opt-out of such sales or targeted advertising. You have the right to appeal a denial of your privacy rights. To take advantage of either of your rights under Virginia law, or to submit an appeal to a denial of these rights, please contact us at info@thorsignals.com. We may ask you to fill out a request form. We can only act on your request if we can verify your identity or your authority to make the request so you will also need to follow our instructions for identity verification. If you make a verifiable request per the above, we will confirm our receipt and respond in the time frames prescribed by Virginia law.
            </p>

            <h3 className="text-xl font-semibold text-white mt-8 mb-4">THE EU GENERAL DATA PROTECTION REGULATION</h3>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">What do we collect from you in the GDPR Jurisdictions and how do we use it?</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Cross-border Data Transfers and Third-Party Processors</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold text-white mt-6 mb-3">Rights of Data Subjects in the GDPR Jurisdictions</h4>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">CHANGES TO THIS PRIVACY STATEMENT</h3>
            <p>
                This privacy statement was drafted on July 6, 2024, and is effective as of this date. The English language version of this privacy statement is the controlling version regardless of any translation you may attempt.
            </p>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">CONTACTING US</h3>
            <p>
                If you have questions about our privacy statement or privacy practices, please email us at: info@thorsignals.com
            </p>
        </div>
    )
}
